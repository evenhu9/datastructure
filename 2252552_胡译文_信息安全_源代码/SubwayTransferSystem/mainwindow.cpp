...
void MainWindow::initStatusBar()
{
    ...
    statusLabel1->setText(tr("作者： 2252552 胡译文"));
...
void MainWindow::on_comboBoxStartLine_currentTextChanged(const QString &arg1)
{
    transferStartLineChanged(arg1);
}

void MainWindow::on_comboBoxDstLine_currentTextChanged(const QString &arg1)
{
    transferDstLineChanged(arg1);
}
//换乘出发线路改变槽函数
